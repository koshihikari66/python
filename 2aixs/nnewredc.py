...
PITCH_KP, PITCH_KI, PITCH_KD = 0.05, 0.0, 0.001
...
# ── 피치 축 2서보(토크 보강) ────────────────────────────────
# 하드웨어 PWM은 채널이 2개뿐이라 포기하고, 이 서보는 pigpio 소프트웨어
# PWM으로 구동한다(sccpid_first_order.py 참고). 안 쓰려면 None으로 둔다.
PITCH_PIN2        = 24     # TODO: 실제 배선한 GPIO 번호로 변경
PITCH2_MIRRORED   = False  # 두 서보가 반대로 도는 것 같으면 True로 변경
...
servo = ServoController(
    ...
    pitch_pin2=PITCH_PIN2, pitch2_mirrored=PITCH2_MIRRORED,
)
