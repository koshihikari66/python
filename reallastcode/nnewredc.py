...
YAW_KP,   YAW_KI,   YAW_KD   = 1.1, 0.0, 0.011
PITCH_KP, PITCH_KI, PITCH_KD = 1.1, 0.0, 0.011

YAW_OUTPUT_LIMIT   = 4.0
PITCH_OUTPUT_LIMIT = 4.0
...
servo = ServoController(
    ...
    yaw_servo_tau=YAW_SERVO_TAU, pitch_servo_tau=PITCH_SERVO_TAU,
...
H_LOW1,  S_LOW1,  V_LOW1  =   0, 130, 130
H_HIGH1, S_HIGH1, V_HIGH1 =  12, 255, 255
H_LOW2,  S_LOW2,  V_LOW2  = 168, 130, 130
...
BLEND_ALPHA = 0.5   # 0.0=correction만, 1.0=prediction만 (반드시 0~1)
